        ...
        <div class="new-story__header">
          <div class="container">
            ...
            <p class="new-story__header__description">
              Please complete this form to share your story with others.
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="container">
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            ...
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Photos</label>
              <div id="documentations-more-info">You can include photos to complement your story.</div>
  ...
  #setupForm() {
    ...
    this.#form.addEventListener("submit", async (event) => {
      ...
      const data = {
        ...
        photo: this.#takenDocumentations.map(
