        ...
        <div class="register-form-container">
          ...
          <form id="register-form" class="register-form">
            ...
            <div class="form-control">
              ...
              <div class="register-form__title-container">
                <input id="password-input" type="password" name="password" placeholder="Enter a new password">
              </div>
            </div>
            <div class="form-buttons register-form__form-buttons">
              ...
              <p class="register-form__already-have-account">Already have an account? <a href="#/login">Sign In</a></p>
            </div>
          </form>
        </div>
      </section>
